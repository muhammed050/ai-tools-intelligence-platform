...
export const metadata = { metadataBase: new URL(siteUrl), title: { default: 'Eldevo — AI Tools Intelligence', template: '%s | Eldevo' }, description: SITE_DESCRIPTION, keywords: ['AI tools', 'AI tool finder', 'AI workflows', 'AI software directory'], alternates: { canonical: '/', languages: { en: '/', ar: '/ar' } }, openGraph: { type: 'website', siteName: SITE_NAME, title: 'Eldevo — AI Tools Intelligence', description: SITE_DESCRIPTION, url: siteUrl }, twitter: { card: 'summary_large_image', title: 'Eldevo — AI Tools Intelligence', description: SITE_DESCRIPTION }, robots: { index: true, follow: true, googleBot: { index: true, follow: true, 'max-image-preview': 'large', 'max-snippet': -1 } } }
...
const nav = [
  ...
  { href: '/blog', key: 'guides', icon: BookOpen },
] as const
